...
const MyTimeslotConsole: FC<TimeslotDisplayProps> = ({formatRegisteredTimeslot, width}) => {
  return (
    <div className="grid w-full px-4">
      <div className={`grid ${width > 600 && formatRegisteredTimeslot().length > 0 ? 'grid-cols-2' : 'grid-cols-1'} border-gray-500 border rounded-lg px-4 py-2 w-full my-4 items-center justify-center gap-4`}>
