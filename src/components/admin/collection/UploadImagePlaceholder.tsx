...
export const UploadImagePlaceholder = (props: UploadComponentProps) => {
  ...
  return (
    <div {...rootProps}>
      ...
      >
        <label htmlFor="dropzone-set-file" className="flex flex-col items-center justify-center w-full h-full border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
