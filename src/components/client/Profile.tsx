                ...
                user ? (
                    <div className="flex flex-col gap-2 text-center border-gray-500 border rounded-lg px-6 py-2 w-[60%]">
                        ...
                        <div className="grid lg:grid-cols-2 md:grid-cols-1 gap-6 mb-6">
                            ...
                            <div className="flex flex-row gap-4 items-center justify-between px-4">
                                <Label className="ms-2 mb-1 font-semibold text-xl" htmlFor="email">Participant Email:</Label>
                                <TextInput sizing='sm' className="w-[60%]" placeholder="Email" type="email" id="email" name="email" defaultValue={user.participantEmail} onChange={(event) => setParticipantEmail(event.target.value)}/>
                            </div>
                            <div className="flex flex-row gap-4 items-center justify-between px-4">
