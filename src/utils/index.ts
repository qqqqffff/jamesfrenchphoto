...
export const textInputTheme: CustomFlowbiteTheme['textInput'] = {
    field: {
        input: {
            ...
            colors: {
                'pink-400': "text-pink-400 bg-gray-100 bg-gray-50 border-gray-300",
                'rose-500': "text-rose-500 bg-gray-50 border-gray-300",
                'red-600': "text-red-600 bg-gray-50 border-gray-300",
                'fuchsia-600': "text-fuchsia-600 bg-gray-50 border-gray-300",
                'purple-600': "text-purple-600 bg-gray-50 border-gray-300",
                'blue-500': "text-blue-500 bg-gray-50 border-gray-300",
                'sky-400': "text-sky-400 bg-gray-50 border-gray-300",
                'cyan-400': "text-cyan-400 bg-gray-50 border-gray-300",
                'emerald-500': "text-emerald-500 bg-gray-50 border-gray-300",
                'green-500': "text-green-500 bg-gray-50 border-gray-300",
                'lime-400': "text-lime-400 bg-gray-50 border-gray-300",
                'yellow-300': "text-yellow-300 bg-gray-50 border-gray-300",
                'orange-400': "text-orange-400 bg-gray-50 border-gray-300",
                'amber-600': "text-amber-600 bg-gray-50 border-gray-300",
            }
        }
    }
}